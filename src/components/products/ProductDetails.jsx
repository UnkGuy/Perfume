      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="space-y-4 mb-10 pt-6 border-t border-white/10">
            {product.available
              ? <div className="flex items-center gap-2 text-green-400"><Check size={18} /><span className="text-sm font-medium">In Stock and ready to ship</span></div>
              : <div className="flex items-center gap-2 text-red-400"><AlertCircle size={18} /><span className="text-sm font-medium">Currently Out of Stock</span></div>}
          </div>
          ...
          <button
            ...
            className={`w-full py-4 font-bold rounded flex items-center justify-center gap-2 transition-all shadow-lg text-lg ${product.available ? 'bg-gold-400 hover:bg-gold-300 text-rich-black' : 'bg-gray-800 text-gray-500 cursor-not-allowed opacity-80'}`}
          >
              ...
              <div key={review.id} className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:border-white/20 transition-colors">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-white text-sm">Verified Buyer</p>

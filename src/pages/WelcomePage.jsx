...
const FeatureCard = ({ icon, title, description, delay }) => {
  ...
  return (
    <div
      ref={ref}
      className="reveal-up flex flex-col items-center"
      style={{ '--delay': delay }}
    >
  ...
  return (
    <div className="min-h-screen bg-rich-black text-white font-sans flex flex-col selection:bg-gold-400 selection:text-black">
      ...
      <style>{`
        ...
        .reveal-up:hover .feature-title {
          color: #d4af37;
        }

        /* ── Story image: slides in from left with subtle scale ── */
        .story-image-wrap {
          opacity: 0;
        ...
        /* ── Gold divider line that grows in ── */
        .story-divider {
          display: block;
          width: 0;
          height: 2px;
        ...
        .reveal-fade.is-visible .story-divider {
          width: 64px;
        }
      `}</style>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <FeatureCard
                ...
                description="Sourced globally from the finest botanicals to ensure a rich, long-lasting scent profile."
                delay="0s"
              />
              <FeatureCard
                icon={<Droplets size={28} />}
                title="Extrait de Parfum"
                description="Highly concentrated formulations guaranteeing projection and longevity throughout your day."
                delay="0.15s"
              />
              <FeatureCard
                icon={<Wind size={28} />}
                title="Artisan Crafted"
                description="Blended and aged perfectly by master perfumers to achieve ultimate olfactory balance."
                delay="0.3s"
              />
            </div>
          </div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              {/* Image slides in from the left with a subtle scale */}
              <div
                ref={storyImageRef}
                className="story-image-wrap w-full md:w-1/2 relative aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden"
              >
                <img 
                  src={HERO_IMAGE} 
              ...
              {/* Text column — each piece staggers in from the right */}
              <div className="w-full md:w-1/2 flex flex-col">

                {/* Animated gold divider line + heading */}
                <div
                  ref={storyHeadingRef}
                ...
                <p
                  ref={storyP1Ref}
                  className="reveal-right text-gray-400 text-lg leading-relaxed mb-6"
                  style={{ '--delay': '0.2s' }}
                >
                ...
                <p
                  ref={storyP2Ref}
                  className="reveal-right text-gray-400 text-lg leading-relaxed mb-8"
                  style={{ '--delay': '0.32s' }}
                >

...
const ResetPasswordPage = ({ setCurrentPage, showToast, onPasswordUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      showToast('Success!', 'Your password has been updated. You can now log in.');
      // Call the callback to signal the app that the password has been updated
      onPasswordUpdate(); 

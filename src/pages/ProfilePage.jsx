...
import { Package, Clock, RefreshCw, LogOut, ArrowLeft } from 'lucide-react';
import Header from '../components/common/Header';
import Footer from '../components/common/Footer';
import { useUserOrders } from '../hooks/useUserOrders'; // Hook handles logic
...
const ProfilePage = ({ 
  ...
  // Pull data from hook
  const { orderHistory, isLoading } = useUserOrders(user?.id);
